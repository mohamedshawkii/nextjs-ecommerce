...
export default function StoreAllProduct(productsData: any) {
    ...
    return (
        <section className='Xsm:max-Beforexl:w-full w-full'>
            <div className=' h-[60rem] overflow-y-scroll overflow-x-hidden'>
                {NewproductsData && (
                    <div className='
                    grid
                    Xsm:max-sm:grid-cols-1
                    sm:max-lg:grid-cols-2
                    lg:max-Beforexl:grid-cols-3
